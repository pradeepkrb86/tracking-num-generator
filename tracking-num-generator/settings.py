...
SECRET_KEY = 'django-insecure-6^mok_v)fd6ee+#=phs2()8nt7q$(dp9j24r13*20bnhlpvg=a'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['scalpro.online','www.scalpro.online','localhost','127.0.0.1']
#ALLOWED_HOSTS = ['scalpro.online','www.scalpro.online']
